...
const LANGS_GL = {
  en:{wd_bis:"New account: until {0} you can withdraw from your contract of use without giving a reason.",
      ...
      mo_erkl:"Moons are earned, never bought. Up to four orbit your world and count only in Ascent — at most 8 % each. In the League everyone is equal.",
  ...
  de:{wd_bis:"Neues Konto: Bis {0} kannst du den Nutzungsvertrag ohne Angabe von Gründen widerrufen.",
      ...
      mo_erkl:"Monde erspielt man, kaufen kann man sie nicht. Bis zu vier kreisen um deine Welt und zählen nur im Aufstieg — höchstens 8 % je Mond. In der Liga sind alle gleich.",
...
const LANGS_GL5 = {
  es:{wd_bis:"Cuenta nueva: hasta el {0} puedes desistir del contrato de uso sin dar motivos.",
      ...
      mo_erkl:"Las lunas se ganan, nunca se compran. Hasta cuatro orbitan tu mundo y solo cuentan en Ascenso — como mucho 8 % cada una. En la Liga todos son iguales.",
  ...
  pt:{wd_bis:"Conta nova: até {0} você pode desistir do contrato de uso sem dar motivo.",
      ...
      mo_erkl:"Luas se conquistam, nunca se compram. Até quatro orbitam seu mundo e só contam na Ascensão — no máximo 8 % cada. Na Liga todos são iguais.",
  ...
  fr:{wd_bis:"Nouveau compte : jusqu’au {0}, vous pouvez vous rétracter du contrat d’utilisation sans motif.",
      ...
      mo_erkl:"Les lunes se gagnent, jamais ne s’achètent. Jusqu’à quatre tournent autour de votre monde et ne comptent qu’en Ascension — au plus 8 % chacune. En Ligue, tout le monde est égal.",
  ...
  tr:{wd_bis:"Yeni hesap: {0} tarihine kadar kullanım sözleşmesinden gerekçe göstermeden cayabilirsin.",
      ...
      mo_erkl:"Uydular kazanılır, asla satın alınmaz. En fazla dördü dünyanın etrafında döner ve yalnızca Yükseliş’te sayılır — her biri en çok % 8. Lig’de herkes eşittir.",
  ...
  ru:{wd_bis:"Новый аккаунт: до {0} вы можете отказаться от договора пользования без объяснения причин.",
      ...
      mo_erkl:"Луны зарабатывают, а не покупают. До четырёх вращаются вокруг вашего мира и считаются только в Восхождении — не более 8 % каждая. В Лиге все равны.",
