...
const LANGS102 = {
  ...
  pt:{hilfe:"Como jogar", rg_head:"Patentes", rg_sub:"Só com conta. A honra não se compra nem se perde.", rg_jagd:"Caça online", rg_jagd_w:"1–36 por rival", rg_jagd_h:"Devora outra conta de jogador. Quanto mais perto a presa estiver do tamanho do teu pedaço que a come e quanto mais pesar, mais honra. Uma presa com menos de um terço desse pedaço não dá nada. Cada rival conta uma vez por dia, os NPC nunca. Em «Ascensão» também conta o nível: uma presa de nível superior dá até 2,5 vezes mais; de nível inferior, menos.", rg_erf:"Conquistas", rg_erf_w:"{0}–{1} por etapa", rg_erf_h:"Cada etapa conta uma vez — {0} de honra no total.", rg_bonus:"Bónus diário", rg_bonus_w:"{0} de honra", rg_bonus_h:"No {0}.º dia da semana de bónus.", rg_bleibt:"Até {0}, uma patente é tua para sempre. A partir de {1} conta o teu lugar no país — essas patentes podem perder-se.", rg_start:"Todos começam aqui", rg_ab:"a partir de {0} de honra", rg_anteil:"os {0} % melhores do seu país, a partir de {1} de honra", rg_plaetze:"os {0} melhores do seu país, a partir de {1} de honra", rg_erster:"o melhor do seu país, a partir de {0} de honra", rg_du:"a sua patente"},
  fr:{hilfe:"Comment jouer", rg_head:"Grades", rg_sub:"Seulement avec un compte. L'honneur ne s'achète pas et ne se perd pas.", rg_jagd:"Chasse en ligne", rg_jagd_w:"1–36 par adversaire", rg_jagd_h:"Avale un autre compte joueur. Plus la proie est proche de la taille du morceau qui l'avale et plus elle est lourde, plus tu gagnes d'honneur. Une proie de moins d'un tiers de ce morceau ne rapporte rien. Chaque adversaire compte une fois par jour, les PNJ jamais. En « Ascension », le niveau compte aussi : une proie de niveau supérieur rapporte jusqu'à 2,5 fois plus, une de niveau inférieur moins.", rg_erf:"Succès", rg_erf_w:"{0}–{1} par palier", rg_erf_h:"Chaque palier compte une fois — {0} d'honneur au total.", rg_bonus:"Bonus quotidien", rg_bonus_w:"{0} d'honneur", rg_bonus_h:"Le {0}e jour de la semaine de bonus.", rg_bleibt:"Jusqu'à {0}, un grade t'appartient pour toujours. À partir de {1}, ta place dans ton pays compte — ces grades peuvent se perdre.", rg_start:"Tout le monde commence ici", rg_ab:"à partir de {0} d'honneur", rg_anteil:"les {0} % meilleurs de votre pays, à partir de {1} d'honneur", rg_plaetze:"les {0} meilleurs de votre pays, à partir de {1} d'honneur", rg_erster:"le meilleur de votre pays, à partir de {0} d'honneur", rg_du:"votre grade"},
  ...
  ru:{hilfe:"Как играть", rg_head:"Звания", rg_sub:"Только с учётной записью. Честь нельзя купить и нельзя потерять.", rg_jagd:"Охота онлайн", rg_jagd_w:"1–36 за соперника", rg_jagd_h:"Съешь другую учётную запись игрока. Чем ближе добыча к размеру твоей части, которая её ест, и чем она тяжелее, тем больше чести. Добыча меньше трети этой части не даёт ничего. Каждый соперник засчитывается раз в день, NPC — никогда. В «Восхождении» важен и уровень: добыча более высокого уровня даёт до 2,5 раза больше, более низкого — меньше.", rg_erf:"Достижения", rg_erf_w:"{0}–{1} за ступень", rg_erf_h:"Каждая ступень засчитывается один раз — всего {0} чести.", rg_bonus:"Ежедневный бонус", rg_bonus_w:"{0} чести", rg_bonus_h:"В {0}-й день бонусной недели.", rg_bleibt:"До звания «{0}» звание остаётся навсегда. С «{1}» важно твоё место в стране — эти звания можно потерять.", rg_start:"Здесь начинают все", rg_ab:"от {0} чести", rg_anteil:"лучшие {0} % вашей страны, от {1} чести", rg_plaetze:"{0} лучших вашей страны, от {1} чести", rg_erster:"лучший в своей стране, от {0} чести", rg_du:"ваше звание"}
};
...
const LANGS_GL5 = {
  ...
  pt:{wd_bis:"Conta nova: até {0} você pode desistir do contrato de uso sem dar motivo.",
      ...
      mo_erkl:"As luas conquistam-se a jogar; uma delas também está na loja, por Irídio. Até quatro orbitam seu mundo e só contam na Ascensão — no máximo 8 % cada. Na Liga todos são iguais.",
...
const LANGS_KERN = {
  ...
  ru:{iridium:"Иридий", ir_nichtkauf:"Не продаётся — только за игру.", ir_woher:"Откуда берётся иридий", ir_w_auf:"Задания: три в день, одна замена.", ir_w_saison:"Места в сезоне: от 20 до 500 за сезон.", ir_w_kapsel:"Капсулы в игре: изредка 2–5 иридия.",
      ...
      ke_kopf:"Ядро", ke_erkl:"Ядро находится в центре вашего мира и делает игру выгоднее — но не сильнее. Открытие и улучшение стоят иридий.", ke_eisen:"Железное ядро", ke_kristall:"Кристальное ядро", ke_glut:"Раскалённое ядро", ke_eisen_w:"+{0} % руды за раунд", ke_kristall_w:"+{0} % опыта за раунд", ke_glut_w:"+{0} лунной пыли за раунд Восхождения, находка луны +{1} пункта", ke_keiner:"Ядро не установлено", ke_stufe:"Уровень {0}", ke_anlegen:"Установить", ke_ablegen:"Снять", ke_angelegt:"Установлено", ke_frei:"Открыть · {0} иридия", ke_aufwerten:"Улучшить · {0} иридия", ke_max:"Максимальный уровень", ke_fehlt:"Не хватает {0} иридия", ke_geschenk:"Первое железное ядро приходит с достижением «Первый мир».", ke_neu:"Новое ядро: {0}", ke_ersatz:"Железное ядро уже есть — +{0} иридия", ke_zeile:"Бонус ядра", ke_platz:"Слот ядра",
