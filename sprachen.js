...
const LANGS_KERN = {
  en:{iridium:"Iridium", ir_nichtkauf:"Not for sale — earned only.", ir_woher:"Where Iridium comes from", ir_w_auf:"Missions: three a day, one swap.", ir_w_saison:"Season ranks: 20 to 500 per season.", ir_w_kapsel:"Capsules in the game: mostly 3–8 Iridium, sometimes moondust, rarely a moon.",
      ...
      ka_iridium:"Capsule: +{0} Iridium", ka_staub:"Capsule: +{0} moondust", ka_mond:"Capsule: a moon — {0}", ka_gast:"Capsule — Iridium only with an account", ka_zeile:"{0} capsules opened",
  ...
  de:{iridium:"Iridium", ir_nichtkauf:"Nicht käuflich — nur erspielbar.", ir_woher:"Woher Iridium kommt", ir_w_auf:"Aufträge: drei am Tag, ein Tausch.", ir_w_saison:"Saisonplätze: 20 bis 500 je Saison.", ir_w_kapsel:"Kapseln im Spiel: meist 3–8 Iridium, manchmal Mondstaub, selten ein Mond.",
      ...
      ka_iridium:"Kapsel: +{0} Iridium", ka_staub:"Kapsel: +{0} Mondstaub", ka_mond:"Kapsel: ein Mond — {0}", ka_gast:"Kapsel — Iridium gibt es nur mit Konto", ka_zeile:"{0} Kapseln geöffnet",
  ...
  es:{iridium:"Iridio", ir_nichtkauf:"No se vende — solo se gana jugando.", ir_woher:"De dónde sale el Iridio", ir_w_auf:"Misiones: tres al día, un cambio.", ir_w_saison:"Puestos de temporada: de 20 a 500 por temporada.", ir_w_kapsel:"Cápsulas en el juego: casi siempre 3–8 Iridio, a veces polvo lunar, rara vez una luna.",
      ...
      ka_iridium:"Cápsula: +{0} Iridio", ka_staub:"Cápsula: +{0} polvo lunar", ka_mond:"Cápsula: una luna — {0}", ka_gast:"Cápsula — el Iridio solo con cuenta", ka_zeile:"{0} cápsulas abiertas",
  ...
  pt:{iridium:"Irídio", ir_nichtkauf:"Não se vende — só se conquista jogando.", ir_woher:"De onde vem o Irídio", ir_w_auf:"Missões: três por dia, uma troca.", ir_w_saison:"Posições da temporada: de 20 a 500 por temporada.", ir_w_kapsel:"Cápsulas no jogo: quase sempre 3–8 Irídio, às vezes poeira lunar, raramente uma lua.",
      ...
      ka_iridium:"Cápsula: +{0} Irídio", ka_staub:"Cápsula: +{0} poeira lunar", ka_mond:"Cápsula: uma lua — {0}", ka_gast:"Cápsula — Irídio só com conta", ka_zeile:"{0} cápsulas abertas",
  ...
  fr:{iridium:"Iridium", ir_nichtkauf:"Pas en vente — uniquement en jouant.", ir_woher:"D’où vient l’Iridium", ir_w_auf:"Missions : trois par jour, un échange.", ir_w_saison:"Rangs de saison : de 20 à 500 par saison.", ir_w_kapsel:"Capsules en jeu : le plus souvent 3–8 Iridium, parfois de la poussière de lune, rarement une lune.",
      ...
      ka_iridium:"Capsule : +{0} Iridium", ka_staub:"Capsule : +{0} poussière de lune", ka_mond:"Capsule : une lune — {0}", ka_gast:"Capsule — l’Iridium seulement avec un compte", ka_zeile:"{0} capsules ouvertes",
  ...
  tr:{iridium:"İridyum", ir_nichtkauf:"Satılmaz — yalnızca oynayarak kazanılır.", ir_woher:"İridyum nereden gelir", ir_w_auf:"Görevler: günde üç, bir değişim.", ir_w_saison:"Sezon sıraları: sezon başına 20 ile 500 arası.", ir_w_kapsel:"Oyundaki kapsüller: çoğunlukla 3–8 İridyum, bazen ay tozu, nadiren bir uydu.",
      ...
      ka_iridium:"Kapsül: +{0} İridyum", ka_staub:"Kapsül: +{0} ay tozu", ka_mond:"Kapsül: bir uydu — {0}", ka_gast:"Kapsül — İridyum yalnızca hesapla", ka_zeile:"{0} kapsül açıldı",
  ...
  ru:{iridium:"Иридий", ir_nichtkauf:"Не продаётся — только за игру.", ir_woher:"Откуда берётся иридий", ir_w_auf:"Задания: три в день, одна замена.", ir_w_saison:"Места в сезоне: от 20 до 500 за сезон.", ir_w_kapsel:"Капсулы в игре: чаще всего 3–8 иридия, иногда лунная пыль, редко луна.",
      ...
      ka_iridium:"Капсула: +{0} иридия", ka_staub:"Капсула: +{0} лунной пыли", ka_mond:"Капсула: луна — {0}", ka_gast:"Капсула — иридий только с аккаунтом", ka_zeile:"Открыто капсул: {0}",
...
const LANGS_TUT2 = {
  en:{tu_steuern_maus:"Move the mouse — your body follows it.", tu_steuern_tipp:"Drag your left thumb across the screen — your body follows.", tu_steuern_tipp_r:"Drag your right thumb across the screen — your body follows.",
      tu_staub:"Sweep up the glowing stardust.", tu_masse:"Top left is your mass. It grows with every grain.",
      tu_vesta_maus:"Vesta is only half your size. Aim at her and press Space: you shoot forward and swallow her.",
      tu_vesta_tipp:"Vesta is only half your size. Aim at her and tap Split: you shoot forward and swallow her.",
      tu_abwerfen_maus:"Shed (W) throws mass forward — to friends, or into a pulsar. Throw five chunks into the pulsar, then it fires.",
      tu_abwerfen_tipp:"Shed throws mass forward — to friends, or into a pulsar. Throw five chunks into the pulsar, then it fires.",
      tu_treffen:"The pulsar flies the way you threw. Stand on the line and hit Kepler — here you have endless mass.",
  ...
  de:{tu_steuern_maus:"Bewege die Maus — dein Körper folgt ihr.", tu_steuern_tipp:"Zieh mit dem linken Daumen über den Schirm — dein Körper folgt.", tu_steuern_tipp_r:"Zieh mit dem rechten Daumen über den Schirm — dein Körper folgt.",
      tu_staub:"Sammle den leuchtenden Sternenstaub ein.", tu_masse:"Oben links steht deine Masse. Sie wächst mit jedem Korn.",
      tu_vesta_maus:"Vesta ist nur halb so groß wie du. Zeig auf sie und drück die Leertaste: Du schießt nach vorn und verschlingst sie.",
      tu_vesta_tipp:"Vesta ist nur halb so groß wie du. Zeig auf sie und tipp auf Teilen: Du schießt nach vorn und verschlingst sie.",
      tu_abwerfen_maus:"Abwerfen (W) wirft Masse nach vorn — an Freunde, oder in einen Pulsar. Wirf fünf Brocken in den Pulsar, dann feuert er.",
      tu_abwerfen_tipp:"Abwerfen wirft Masse nach vorn — an Freunde, oder in einen Pulsar. Wirf fünf Brocken in den Pulsar, dann feuert er.",
      tu_treffen:"Der Pulsar fliegt in Wurfrichtung. Stell dich auf die Linie und triff Kepler — Masse hast du hier ohne Ende.",
