...
const LANGS_PUSH = {
  en:{s_push:"Notifications", s_push_h:"Daily bonus, clan battle, season result — only what you pick.",
      ...
      pv_ios:"On iPhone and iPad, notifications only work when Talumi is on your home screen.", pv_ios_knopf:"Show me how",
      ...
      po_frage:"Remind you when the next bonus is ready?", po_ja:"Yes, remind me", po_nein:"No thanks",
  ...
  de:{s_push:"Benachrichtigungen", s_push_h:"Tagesbonus, Clankampf, Saisonergebnis — nur, was du auswählst.",
      ...
      pv_ios:"Auf iPhone und iPad gibt es Benachrichtigungen nur, wenn Talumi auf dem Home-Bildschirm liegt.", pv_ios_knopf:"So geht's",
      ...
      po_frage:"Erinnern, wenn der nächste Bonus bereitliegt?", po_ja:"Ja, erinnern", po_nein:"Nein danke",
  ...
  es:{s_push:"Notificaciones", s_push_h:"Bono diario, batalla de clanes, resultado de temporada: solo lo que elijas.",
      ...
      pv_ios:"En iPhone y iPad las notificaciones solo funcionan si Talumi está en la pantalla de inicio.", pv_ios_knopf:"Cómo hacerlo",
      ...
      po_frage:"¿Te avisamos cuando esté listo el próximo bono?", po_ja:"Sí, avísame", po_nein:"No, gracias",
  ...
  pt:{s_push:"Notificações", s_push_h:"Bónus diário, batalha de clãs, resultado da temporada — só o que escolheres.",
      ...
      pv_ios:"No iPhone e iPad, as notificações só funcionam se o Talumi estiver no ecrã principal.", pv_ios_knopf:"Como fazer",
      ...
      po_frage:"Avisar-te quando o próximo bónus estiver pronto?", po_ja:"Sim, avisa-me", po_nein:"Não, obrigado",
  ...
  fr:{s_push:"Notifications", s_push_h:"Bonus du jour, bataille de clans, résultat de saison — seulement ce que tu choisis.",
      ...
      pv_ios:"Sur iPhone et iPad, les notifications ne fonctionnent que si Talumi est sur l'écran d'accueil.", pv_ios_knopf:"Voir comment",
      ...
      po_frage:"Te rappeler quand le prochain bonus est prêt ?", po_ja:"Oui, rappelle-moi", po_nein:"Non merci",
  ...
  tr:{s_push:"Bildirimler", s_push_h:"Günlük bonus, klan savaşı, sezon sonucu — yalnızca seçtiklerin.",
      ...
      pv_ios:"iPhone ve iPad'de bildirimler yalnızca Talumi ana ekrandayken çalışır.", pv_ios_knopf:"Nasıl yapılır",
      ...
      po_frage:"Sonraki bonus hazır olunca hatırlatalım mı?", po_ja:"Evet, hatırlat", po_nein:"Hayır, teşekkürler",
  ...
  ru:{s_push:"Уведомления", s_push_h:"Ежедневный бонус, клановая битва, итоги сезона — только то, что выберешь.",
      ...
      pv_ios:"На iPhone и iPad уведомления работают, только если Talumi добавлен на экран «Домой».", pv_ios_knopf:"Как это сделать",
      ...
      po_frage:"Напомнить, когда будет готов следующий бонус?", po_ja:"Да, напоминай", po_nein:"Нет, спасибо",
