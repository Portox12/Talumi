...
const LANGS9 = {
  ...
  es:{menu:"Menú", fair:"Juego limpio", fair1:"Sin cookies, sin rastreo, sin contenido de terceros. Con sesión iniciada solo se guarda tu clave de sesión en el dispositivo, para que sigas dentro. Nada más.", fair2:"Nada de lo que se vende da una ventaja duradera. Todos los diseños se ganan jugando; comprar solo ahorra espera.", fair3:"La publicidad nunca interrumpe una partida en curso ni tus primeros minutos.", fair4:"El antibots solo mira el ritmo y el movimiento de entrada. No se envía nada."},
  pt:{menu:"Menu", fair:"Jogo limpo", fair1:"Sem cookies, sem rastreio, sem conteúdo de terceiros. Com sessão iniciada guarda-se apenas a sua chave de sessão no aparelho, para continuar ligado. Mais nada.", fair2:"Nada à venda dá vantagem duradoura. Todo design se conquista jogando; comprar só poupa espera.", fair3:"A publicidade nunca interrompe uma partida em andamento nem os seus primeiros minutos.", fair4:"O antibôs olha apenas o ritmo e o movimento das entradas. Nada é enviado."},
  fr:{menu:"Menu", fair:"Fair-play", fair1:"Ni cookies, ni suivi, ni contenu tiers. Une fois connecté, seule votre clé de session est stockée sur l appareil, pour que vous restiez connecté. Rien d autre.", fair2:"Rien de ce qui est vendu ne donne d'avantage durable. Chaque design se gagne en jouant ; acheter fait juste gagner du temps.", fair3:"La publicité n'interrompt jamais une manche en cours, ni vos premières minutes.", fair4:"L'anti-bot n'observe que le rythme et le mouvement des entrées. Rien n'est transmis."},
  tr:{menu:"Menü", fair:"Adil oyun", fair1:"Çerez yok, izleme yok, üçüncü taraf içerik yok. Giriş yaptığında yalnızca oturum anahtarın cihazda saklanır, giriş yapmış kalasın diye. Başka bir şey değil.", fair2:"Satılan hiçbir şey kalıcı avantaj vermez. Her tasarım oynayarak kazanılır; satın almak yalnızca beklemeyi kısaltır.", fair3:"Reklam asla süren bir turu ve ilk dakikalarını bölmez.", fair4:"Bot koruması yalnızca giriş ritmine ve harekete bakar. Hiçbir şey gönderilmez."},
  ru:{menu:"Меню", fair:"Честная игра", fair1:"Ни кук, ни слежки, ни сторонних материалов. После входа на устройстве хранится только ключ сессии, чтобы вы оставались в аккаунте. Больше ничего.", fair2:"Ничто из продаваемого не даёт долгого преимущества. Любой дизайн добывается игрой, покупка лишь экономит ожидание.", fair3:"Реклама никогда не прерывает идущий раунд и не появляется в первые минуты.", fair4:"Защита от ботов смотрит лишь на ритм и движение ввода. Ничего не отправляется."},
};
